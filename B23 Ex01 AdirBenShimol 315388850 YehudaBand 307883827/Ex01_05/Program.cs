...
namespace Ex01_05
{
    class Program
    {
        ...
        private static bool stringIsSixDigitsNumber(string i_UserInput)
        {
        ...
        private static int getNumberOfDigitsStrictlyLargerThanRightmostDigit(string i_UserInput)
        {
        ...
        private static char getLowestDigit(string i_UserInput)
        {
        ...
        private static float getDigitAverage(string i_userInput)
        {
            float sumOfDigits = 0;
